...
- OpenWrt release `1.16.0-rc7` from this repo boots automatically through the patched stock U-Boot chain. It is based on OpenWRT `v25.12.5` and modified from there.

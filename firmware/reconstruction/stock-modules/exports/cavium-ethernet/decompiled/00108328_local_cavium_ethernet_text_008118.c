 ...
 * Entry: 00108328
 * Function: local_cavium_ethernet_text_008118
...
void local_cavium_ethernet_text_008118(int param_1)

{
  ...
  lVar2 = (*(code *)&cvmx_helper_link_get)(*(undefined4 *)(param_1 + 0x560));
  if (lVar2 != *(longlong *)(param_1 + 0x7e0)) {
    uVar3 = (*(code *)&cvmx_helper_link_autoconf)(*(undefined4 *)(param_1 + 0x560));
    *(undefined8 *)(param_1 + 0x7e0) = uVar3;
    setCopReg(2,unaff_s3,*(undefined4 *)((int)uVar3 + 0x36));
    uVar1 = getCopReg(2,4);
    *(undefined4 *)((int)*(undefined8 *)(param_1 + 0x40) + 99) = uVar1;
    if (*(int *)(param_1 + 0x564) == -1) {
      lVar2 = (*(code *)&__printk_ratelimit)(0xfa,10);
    }
    else {
      lVar2 = (*(code *)&__printk_ratelimit)(0xfa,10);
    }

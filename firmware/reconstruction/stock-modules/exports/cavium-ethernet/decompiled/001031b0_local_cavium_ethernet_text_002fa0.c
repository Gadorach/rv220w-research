 ...
 * Entry: 001031b0
 * Function: local_cavium_ethernet_text_002fa0
...
ulonglong local_cavium_ethernet_text_002fa0(undefined8 param_1,ulonglong param_2,ulonglong param_3)

{
  ...
  while (((ulonglong)(longlong)iVar1 >> 8 & 0xfffff) != 0) {
    setCopReg(2,0x112020,*(undefined4 *)((int)uRam00001810 + 10));
    iVar1 = *(int *)(unaff_gp_lo + 0x24);
  }
  (*(code *)&yield)();
  uVar3 = uRam00001810;
  iVar1 = (int)uRam00001810;
  uVar2 = getCopReg(2,0x11);
  *(undefined4 *)(iVar1 + -8) = uVar2;
  setCopReg(2,0x8001180000001810,*(undefined4 *)(iVar1 + 7));
  return uVar3 & 0xffff;
}

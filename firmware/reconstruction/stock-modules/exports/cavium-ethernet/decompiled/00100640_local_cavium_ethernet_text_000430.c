 ...
 * Entry: 00100640
 * Function: local_cavium_ethernet_text_000430
...
void local_cavium_ethernet_text_000430(undefined8 param_1,undefined8 param_2)

{
  (*(code *)&single_open)(param_2,local_cavium_ethernet_text_000bd8,0);
  return;
}

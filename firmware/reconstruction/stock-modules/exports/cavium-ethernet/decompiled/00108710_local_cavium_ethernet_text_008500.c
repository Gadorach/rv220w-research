 ...
 * Entry: 00108710
 * Function: local_cavium_ethernet_text_008500
...
undefined1  [16] local_cavium_ethernet_text_008500(int param_1)
    ...
    if (0x23 < (longlong)uVar5) {
      ...
      if (uVar5 != 0x28) {
        ...
        *puVar7 = *puVar7 & 0xfffffffffffff00c | 0xff3;
        auVar9._0_8_ = *puVar6 & 0xffffffffffffff00 | 0xff;
        *puVar6 = auVar9._0_8_;
        auVar9._8_8_ = uRam000000f8;
        return auVar9;
      }
    }
    uVar4 = *(uint *)(param_1 + 0x560);

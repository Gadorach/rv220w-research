 ...
 * Entry: 00108810
 * Function: local_cavium_ethernet_text_008600
...
void local_cavium_ethernet_text_008600(undefined8 param_1)

{
  ulonglong *puVar1;
  ulonglong *puVar2;
  
  special2(param_1,param_1,0x1b,0x32);
  puVar2 = (ulonglong *)((int)param_1 + -0x6ffffcf8);
  puVar1 = (ulonglong *)((int)param_1 + -0x6ffff960);
  *puVar2 = *puVar2 & 0xfffffffffffff00c | 0xff3;
  *puVar1 = *puVar1 & 0xffffffffffffff00 | 0xff;
  return;
}

...
void offloadPortConfig(ulonglong param_1)

{
  ulonglong uVar1;
  
  uVar1 = uRama0000200 & 0xffffffffffffff80 | param_1 & 0x7f;
  (*(code *)&printk)(&DAT_0010da90,uRama0000200,uRama0000200 & 0x7f);
  (*(code *)&printk)(&UNK_0010dab8,uVar1,param_1 & 0x7f);
  uRama0000200 = uVar1;
  return;
}

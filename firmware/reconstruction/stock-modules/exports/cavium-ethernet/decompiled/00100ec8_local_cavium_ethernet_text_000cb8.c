 ...
 * Entry: 00100ec8
 * Function: local_cavium_ethernet_text_000cb8
...
undefined8 local_cavium_ethernet_text_000cb8(undefined8 param_1)

{
  (*(code *)&seq_printf)(param_1,&UNK_0010dde8,uRam1ec6ff30,uRam1ec6ff31);
  return 0;
}

 ...
 * Entry: 00103280
 * Function: cvm_oct_mem_empty_fpa
...
void cvm_oct_mem_empty_fpa(undefined8 param_1,undefined8 param_2,int param_3)

{
  while (lRam00000000 != 0) {
    param_3 = param_3 + -1;
    (*(code *)&kfree_skb)(*(undefined8 *)((int)lRam00000000 + -8));
  }
  if ((-1 < param_3) && (param_3 == 0)) {
    return;
  }

 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='setenv', maxargs=64, repeatable=0, usage=''.
 */
...
undefined8 do_setenv(long param_1,undefined8 param_2,long param_3,undefined8 param_4)

{
  ...
  *puVar3 = &_gp;
  ...
  puVar3[1] = in_ra;
  if (1 < param_3) {
    uVar2 = (*(code *)(long)DAT_ffffffffbfc43e0c)(param_2,param_3);
    return uVar2;
  }
  (*(code *)(long)DAT_ffffffffbfc4400c)(iVar1 + -0x5320,*(undefined4 *)(param_1 + 0x10),param_4);
  return 1;
}

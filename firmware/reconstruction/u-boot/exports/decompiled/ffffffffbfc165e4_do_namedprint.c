 ...
 * Entry: ffffffffbfc165e4
 * Function: do_namedprint
 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='namedprint', maxargs=1, repeatable=0, usage=''.
 */
...

{
  ...
  *puVar1 = &_gp;
  puVar1[1] = in_ra;
  (*(code *)(long)DAT_ffffffffbfc4403c)();
  return 0;
}

 ...
 * Entry: ffffffffbfc18d8c
 * Function: do_tftpboot
 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='tftpboot', maxargs=3, repeatable=1, usage=''.
 */
...
undefined8 do_tftpboot(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  puVar3[4] = in_ra;
  puVar3[2] = unaff_s2;
  pcVar2 = (code *)(long)DAT_ffffffffbfc43878;
  puVar3[1] = unaff_s1;
  *puVar3 = unaff_s0;
  (*pcVar2)(1);
  uVar1 = (*(code *)(long)(DAT_ffffffffbfc43700 + -0x7540))(3,param_1,param_3,param_4);

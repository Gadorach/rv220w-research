 ...
 * Entry: ffffffffbfc2bf00
 * Function: FUN_ffffffffbfc2bf00
...
bool FUN_ffffffffbfc2bf00(ulong param_1)
  ...
  if (uVar2 < 0xd03) {
    ...
    if (uVar4 == 0x1000000) {
      ...
      if (uVar4 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc2bfc8;
      }
      if (uVar4 != 0) goto LAB_ffffffffbfc2bfc8;
      uVar4 = 0xffff1f;
    }
    if ((uVar7 & uVar4) != (param_1 & uVar4)) {
LAB_ffffffffbfc2bfc8:
    ...
    if (uVar5 == 0x1000000) {
      ...
      if (uVar5 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc2c050;
      }
      uVar6 = uVar7 & 0xffffff;
      if (uVar5 != 0) goto LAB_ffffffffbfc2c050;
      uVar4 = param_1 & 0xffffff;
    }
    if (uVar6 != uVar4) {
LAB_ffffffffbfc2c050:

 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='read64b', maxargs=2, repeatable=1, usage=''.
 */
...
bool do_read64b(long param_1,undefined8 param_2,long param_3,long param_4)

{
  ...
  *puVar5 = unaff_s0;
  if (param_3 == 2) {
    ...
    (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x3dd0,lVar2);
    uVar3 = (*(code *)(long)DAT_ffffffffbfc43e28)(lVar2);
    (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x3da8,lVar2,uVar3);
  }
  else {

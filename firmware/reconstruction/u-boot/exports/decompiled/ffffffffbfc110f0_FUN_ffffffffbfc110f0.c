 ...
 * Entry: ffffffffbfc110f0
 * Function: FUN_ffffffffbfc110f0
...
undefined8 FUN_ffffffffbfc110f0(undefined8 param_1,undefined8 param_2,uint param_3,uint param_4)

{
  ...
  *(undefined8 *)(puVar4 + 0x10) = in_ra;
  ...
  if (-1 < lVar1) {
    *puVar4 = ~(0xffff << iVar2) & *puVar4 | (param_4 & 0xffff) << iVar2;

 ...
 * Entry: ffffffffbfc167fc
 * Function: do_write64s
 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='write64s', maxargs=4, repeatable=1, usage=''.
 */
...
bool do_write64s(long param_1,undefined8 param_2,long param_3,long param_4)

{
  ...
  pcVar5 = (code *)(long)DAT_ffffffffbfc43730;
  *puVar6 = unaff_s0;
  puVar6[3] = in_ra;
  puVar6[1] = unaff_s1;
  if (param_3 == 3) {
    lVar2 = (*pcVar5)(*(undefined4 *)(param_4 + 4),0,0x10);
    puVar4 = (undefined2 *)(lVar2 + *(long *)((long)DAT_ffffffffbfc436f4 + 0x28f8));
    uVar3 = (*(code *)(long)DAT_ffffffffbfc43730)(*(undefined4 *)(param_4 + 8),0,0x10);
    (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x3e10,uVar3,puVar4);
    *puVar4 = (short)uVar3;
  }
  else {

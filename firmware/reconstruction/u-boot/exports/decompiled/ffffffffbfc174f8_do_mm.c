 ...
 * 
 * 
 * Recovered from U-Boot command table: command='mm', maxargs=2, repeatable=1, usage=''.
 */
...
void do_mm(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  int in_t9_lo;
  
                    /* WARNING: Could not recover jumptable at 0xffffffffbfc1751c. Too many branches
                        */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(long)(*(int *)((long)(in_t9_lo + 0x2c1e8) + 0x1c) + 0x72d8))

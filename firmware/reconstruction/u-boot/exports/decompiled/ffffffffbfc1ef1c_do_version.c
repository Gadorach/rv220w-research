 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='version', maxargs=1, repeatable=1, usage=''.
 */
...

{
  ...
  *puVar1 = &_gp;
  puVar1[1] = in_ra;
  (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + 0xb70,DAT_ffffffffbfc44030);
  return 0;
}

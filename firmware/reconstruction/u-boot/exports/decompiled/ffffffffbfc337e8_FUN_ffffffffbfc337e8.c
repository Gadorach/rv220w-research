 ...
 * Entry: ffffffffbfc337e8
 * Function: FUN_ffffffffbfc337e8
...

{
  ...
  *puVar4 = unaff_s0;
  ...
  if (((((((code *)(long)*(int *)(lVar3 + 4) == (code *)0x0) ||
         (lVar2 = (*(code *)(long)*(int *)(lVar3 + 4))(param_1,param_2,param_4), lVar2 == 0)) &&
        (((code *)(long)*(int *)(lVar3 + 8) == (code *)0x0 ||

 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='write64', maxargs=4, repeatable=1, usage=''.
 */
...
bool do_write64(long param_1,undefined8 param_2,long param_3,long param_4)

{
  ...
  *puVar5 = unaff_s0;
  ...
  if (param_3 == 3) {
    ...
    (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x3df0,uVar3,lVar2);
    (*(code *)(long)(DAT_ffffffffbfc436fc + 0x6350))(lVar2,uVar3);
  }
  else {

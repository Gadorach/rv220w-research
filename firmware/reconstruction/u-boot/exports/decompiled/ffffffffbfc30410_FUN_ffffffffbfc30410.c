 ...
 * Entry: ffffffffbfc30410
 * Function: FUN_ffffffffbfc30410
...
bool FUN_ffffffffbfc30410(ulong param_1)
  ...
  if (uVar2 < 0xd03) {
    ...
    if (uVar4 == 0x1000000) {
      ...
      if (uVar4 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc304d8;
      }
      if (uVar4 != 0) goto LAB_ffffffffbfc304d8;
      uVar4 = 0xffff1f;
    }
    if ((uVar7 & uVar4) != (param_1 & uVar4)) {
LAB_ffffffffbfc304d8:
    ...
    if (uVar5 == 0x1000000) {
      ...
      if (uVar5 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc30560;
      }
      uVar6 = uVar7 & 0xffffff;
      if (uVar5 != 0) goto LAB_ffffffffbfc30560;
      uVar4 = param_1 & 0xffffff;
    }
    if (uVar6 != uVar4) {
LAB_ffffffffbfc30560:

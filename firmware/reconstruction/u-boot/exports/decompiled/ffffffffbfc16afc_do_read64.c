 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='read64', maxargs=2, repeatable=1, usage=''.
 */
...
bool do_read64(long param_1,undefined8 param_2,long param_3,long param_4)

{
  ...
  *puVar5 = unaff_s0;
  if (param_3 == 2) {
    ...
    puVar3 = (undefined8 *)(lVar2 + *(long *)((long)DAT_ffffffffbfc436f4 + 0x28f8));
    (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x3dd0,puVar3);
    (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x3d98,puVar3,*puVar3);
  }
  else {

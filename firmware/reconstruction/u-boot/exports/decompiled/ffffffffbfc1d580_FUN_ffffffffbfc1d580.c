 ...
 * Entry: ffffffffbfc1d580
 * Function: FUN_ffffffffbfc1d580
...
bool FUN_ffffffffbfc1d580(ulong param_1)
  ...
  if (uVar2 < 0xd03) {
    ...
    if (uVar4 == 0x1000000) {
      ...
      if (uVar4 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc1d648;
      }
      if (uVar4 != 0) goto LAB_ffffffffbfc1d648;
      uVar4 = 0xffff1f;
    }
    if ((uVar7 & uVar4) != (param_1 & uVar4)) {
LAB_ffffffffbfc1d648:
    ...
    if (uVar5 == 0x1000000) {
      ...
      if (uVar5 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc1d6d0;
      }
      uVar6 = uVar7 & 0xffffff;
      if (uVar5 != 0) goto LAB_ffffffffbfc1d6d0;
      uVar4 = param_1 & 0xffffff;
    }
    if (uVar6 != uVar4) {
LAB_ffffffffbfc1d6d0:

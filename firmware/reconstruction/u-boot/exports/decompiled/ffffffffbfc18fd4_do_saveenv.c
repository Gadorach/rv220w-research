 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='saveenv', maxargs=1, repeatable=0, usage=''.
 */
...

{
  ...
  *puVar2 = &_gp;
  ...
  (*(code *)(long)DAT_ffffffffbfc4400c)
            (DAT_ffffffffbfc436f4 + -0x21e8,*(undefined4 *)(long)DAT_ffffffffbfc43e54);
  lVar1 = (*(code *)(long)DAT_ffffffffbfc43da8)();
  return lVar1 != 0;
}

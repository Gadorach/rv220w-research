 ...
 * Entry: ffffffffbfc29900
 * Function: FUN_ffffffffbfc29900
...
bool FUN_ffffffffbfc29900(ulong param_1)
  ...
  if (uVar2 < 0xd03) {
    ...
    if (uVar4 == 0x1000000) {
      ...
      if (uVar4 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc299c8;
      }
      if (uVar4 != 0) goto LAB_ffffffffbfc299c8;
      uVar4 = 0xffff1f;
    }
    if ((uVar7 & uVar4) != (param_1 & uVar4)) {
LAB_ffffffffbfc299c8:
    ...
    if (uVar5 == 0x1000000) {
      ...
      if (uVar5 == 0x3000000) {
        ...
        goto LAB_ffffffffbfc29a50;
      }
      uVar6 = uVar7 & 0xffffff;
      if (uVar5 != 0) goto LAB_ffffffffbfc29a50;
      uVar4 = param_1 & 0xffffff;
    }
    if (uVar6 != uVar4) {
LAB_ffffffffbfc29a50:

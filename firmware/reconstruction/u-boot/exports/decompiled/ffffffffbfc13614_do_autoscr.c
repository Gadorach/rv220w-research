 ...
 * Safety: reconstructed pseudocode is not original Cisco source. Do not replay flash, GPIO, MDIO or switch writes without readback and recovery safeguards.
 * 
 * Recovered from U-Boot command table: command='autoscr', maxargs=2, repeatable=0, usage=''.
 */
...
void do_autoscr(undefined8 param_1,undefined8 param_2,long param_3,long param_4)

{
  ...
  *puVar2 = unaff_s0;
  if (param_3 < 2) {
    uVar1 = *(undefined4 *)(long)DAT_ffffffffbfc43d48;
  }
  else {
    uVar1 = (*(code *)(long)DAT_ffffffffbfc438b0)(*(undefined4 *)(param_4 + 4),0,0x10);
  }
  (*(code *)(long)DAT_ffffffffbfc4400c)(DAT_ffffffffbfc436f4 + -0x51c0,uVar1);
  (*(code *)(long)DAT_ffffffffbfc43958)(uVar1);
  return;
}
